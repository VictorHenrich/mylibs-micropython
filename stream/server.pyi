...
class AbstractStreamConnectionHandler(ABC):
...
class StreamServer(socket):
    def __init__(
        self,
        socket_connection_class: Type[AbstractStreamConnectionHandler],
        host: str = "localhost",
    ...
    def __handle_client_connection(
        self, client_connection: AbstractStreamConnectionHandler
    ) -> None: ...
